...
#define STRING_CONFIG_H_AUTHOR "(AKOS, SKR-V1.3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "M: 2.0.8 - 21.05.02"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  25.27 //22.0
    #define DEFAULT_Ki   4.99 //2.43
    #define DEFAULT_Kd  32.00 //49.86
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 26.47
  #define DEFAULT_bedKi 1.33
  #define DEFAULT_bedKd 352.45
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 120, 120, 7, 50 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 25.7,  0, -0.6 }
...
#define MANUAL_X_HOME_POS 186
#define MANUAL_Y_HOME_POS -62
